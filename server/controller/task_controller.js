...
exports.get_task=(req,res)=>{
    ...
    if(task_to_get==false){ // failsafe if the task is not there in the task list saved
...
exports.delete_task=(req,res)=>{
    ...
    if(del==false){ // failsafe if the task is not saved or found
...
exports.update_task=(req,res)=>{
    const up_task=task_func.get_by_id();
    if(up_task==false){
...
router.post("/",ctrl.delete_all_tasks);router.post("/",ctrl.delete_all_tasks);